defmodule SpaceChess.Game.DummyData do
  ...
  @dummy_process_data [
    %{
      ...
      board_dimensions: %{rows: 7, columns: 7, levels: 7},
      turn: 1,
      round: 1,
      promotion_zones: %{
      ...
      piece_behavior: %{
        hand: %{
          ...
          movement: [
            ...
            %{transformation: {1, 0, 0}, steps: 2, opts: [], branches: []},
            %{transformation: {0, 1, 0}, steps: 3, opts: [], branches: []},
          ]
        },
        pawn: %{
          abbreviation: "p",
      ...
      piece_info: %{
        hand: %{
          ...
          orientation: %{up: {-1, 0, 0}, facing: {0, 0, -1}}
        },
        pawn1: %{
          owner: 1,
          behavior: :pawn,
      ...
      moves: %{
        ...
        pawn15: [{5, 3, 5}],
        rook1: [],
        bishop4: [{2, 5, 1}, {3, 5, 2}, {4, 5, 3}, {5, 2, 1}, {5, 3, 2}, {5, 4, 3}],
        pawn5: [{5, 3, 1}],
        pawn1: [{1, 3, 1}],
        unicorn2: [{2, 4, 5}, {3, 3, 4}, {4, 2, 3}],
        unicorn1: [{5, 4, 5}, {4, 3, 4}, {3, 2, 3}, {1, 2, 3}],
        unicorn4: [{5, 4, 3}, {1, 2, 1}, {2, 3, 2}, {3, 4, 3}],
        pawn19: [{4, 4, 3}, {4, 3, 4}],
        queen2: [
          {5, 3, 2},
          {4, 4, 3},
        ...
        pawn20: [{5, 4, 3}, {5, 3, 4}],
        unicorn3: [{4, 2, 1}, {3, 3, 2}, {2, 4, 3}],
        knight1: [{3, 1, 3}, {1, 1, 3}, {2, 2, 3}, {2, 3, 2}, {3, 3, 1}, {1, 3, 1}],
        pawn7: [{2, 2, 3}, {2, 3, 2}],
        rook3: [{1, 4, 5}],
        queen1: [
          {5, 3, 4},
        ...
        pawn11: [{2, 4, 4}, {1, 3, 5}],
        bishop1: [{4, 1, 5}, {3, 1, 4}, {2, 1, 3}, {1, 4, 5}, {1, 3, 4}, {1, 2, 3}],
        knight4: [{5, 5, 3}, {3, 5, 3}, {4, 4, 3}, {4, 3, 4}, {5, 3, 5}, {3, 3, 5}],
        pawn4: [{4, 3, 1}],
        rook2: [],
        knight2: [{5, 1, 3}, {3, 1, 3}, {4, 2, 3}, {4, 3, 2}, {5, 3, 1}, {3, 3, 1}],
        king1: [],
        pawn18: [{3, 4, 3}, {3, 3, 4}],
        pawn14: [{4, 3, 5}],
        pawn12: [{2, 3, 5}],
        ...
        pawn2: [{2, 3, 1}],
        rook4: [],
        knight3: [{3, 5, 3}, {1, 5, 3}, {2, 4, 3}, {2, 3, 4}, {3, 3, 5}, {1, 3, 5}],
        pawn10: [{5, 2, 3}, {5, 3, 2}],
        pawn13: [{3, 3, 5}],
        pawn8: [{3, 2, 3}, {3, 3, 2}],
        pawn9: [{4, 2, 3}, {4, 3, 2}],
